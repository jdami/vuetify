...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        classes: function classes() {
            var _a;
            return _a = {}, _a["theme--" + (this.dark ? 'dark' : 'light')] = true, _a;
        }
    },
    watch: {
        dark: function dark() {
    ...
    computed: {
        ...
        styles: function styles() {
            ...
            if (this.computedPaddingLeft) {
                styles.paddingLeft = (this.$vuetify.rtl ? this.computedPaddingRight : this.computedPaddingLeft) + "px";
            }
            if (this.computedPaddingRight) {
                styles.paddingRight = (this.$vuetify.rtl ? this.computedPaddingLeft : this.computedPaddingRight) + "px";
            }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    render: function render(h, _a) {
        ...
        var data = {
            ...
            on: listeners,
            style: {
                left: Object(_util_helpers__WEBPACK_IMPORTED_MODULE_2__["convertToUnit"])(this.$vuetify.rtl ? props.right : props.left),
                right: Object(_util_helpers__WEBPACK_IMPORTED_MODULE_2__["convertToUnit"])(this.$vuetify.rtl ? props.left : props.right),
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        ...
        styles: function styles() {
            ...
            }, _a[this.$vuetify.rtl ? 'right' : 'left'] = this.calculatedLeft, _a.transformOrigin = this.origin, _a.zIndex = this.zIndex || this.activeZIndex, _a;
        },
    ...
    computed: {
        ...
        styles: function styles() {
            return {
                ...
                paddingRight: (this.$vuetify.rtl ? this.computedPaddingLeft : this.computedPaddingRight) + "px",
                paddingLeft: (this.$vuetify.rtl ? this.computedPaddingRight : this.computedPaddingLeft) + "px",
